...
def is_correct(act, given):
    if isinstance(act, str) and isinstance(given, str):
        return phonetics.metaphone(act) == phonetics.metaphone(given)
    else:
        return act == given
